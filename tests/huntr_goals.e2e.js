...
async function huntrGoals(driver) {
    ...
    const goalsArray = ["Universal Goal #1", "Universal Goal #2", "Universal Goal #3", "Universal Goal #4", "Universal Goal #5", "Universal Goal #6", "Universal Goal #7", "Universal Goal #8"];
